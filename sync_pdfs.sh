...
#   - Corn Belt:    ~/Documents/求职/Du_Sun_Wang_CornBelt_Adaptation.pdf（从 Overleaf 下载新版后先替换这份）
#   - CV:           ~/Documents/求职/Yuhan_Wang_CV.pdf（Word 导出新 PDF 后先替换这份）
set -e
cd "$(dirname "$0")"
...
cp "$HOME/Documents/求职/Du_Sun_Wang_CornBelt_Adaptation.pdf"   assets/pdf/Wang_CornBelt_Adaptation.pdf
cp "$HOME/Documents/求职/Yuhan_Wang_CV.pdf"                     assets/pdf/Yuhan_Wang_CV.pdf
